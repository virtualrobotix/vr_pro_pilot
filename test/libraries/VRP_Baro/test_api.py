#!/usr/bin/env python3
"""SVCP smoke test — VRP_Baro (BASELINE)."""
...
def test_cert_llrd_exists() -> None:
    llrd = ROOT / "certification" / "libraries" / "AP_Baro" / "VRP-LLRD-AP_Baro.yaml"
    assert llrd.exists(), f"Missing {llrd}"


def test_sdd_not_template() -> None:
    sdd = ROOT / "certification" / "libraries" / "AP_Baro" / "VRP-SDD-AP_Baro.md"
    text = sdd.read_text()
