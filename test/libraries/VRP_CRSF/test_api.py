#!/usr/bin/env python3
"""SVCP smoke test — VRP_CRSF (BASELINE)."""
...
def test_cert_llrd_exists() -> None:
    llrd = ROOT / "certification" / "libraries" / "AP_CRSF" / "VRP-LLRD-AP_CRSF.yaml"
    assert llrd.exists(), f"Missing {llrd}"


def test_sdd_not_template() -> None:
    sdd = ROOT / "certification" / "libraries" / "AP_CRSF" / "VRP-SDD-AP_CRSF.md"
    text = sdd.read_text()
