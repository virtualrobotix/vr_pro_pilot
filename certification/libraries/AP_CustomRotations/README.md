# Certification pack — VRP_CustomRotations

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_CustomRotations` |
| VR-Pilot module | `VRP_CustomRotations` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_CustomRotations/`)
...
Codice sorgente: `src/libraries/VRP_CustomRotations/`
