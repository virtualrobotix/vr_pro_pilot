# Certification pack — VRP_WindVane

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_WindVane` |
| VR-Pilot module | `VRP_WindVane` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_WindVane/`)
...
Codice sorgente: `src/libraries/VRP_WindVane/`
