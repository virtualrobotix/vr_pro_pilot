# Certification pack — VRP_Filter

| Field | Value |
|---|---|
| ArduPilot equivalent | `Filter` |
| VR-Pilot module | `VRP_Filter` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_Filter/`)
...
Codice sorgente: `src/libraries/VRP_Filter/`
