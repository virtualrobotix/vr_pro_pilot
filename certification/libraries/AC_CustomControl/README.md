...
| Field | Value |
|---|---|
| ArduPilot equivalent | `AC_CustomControl` |
...
| SDD | [`VRP-SDD-AC_CustomControl.md`](VRP-SDD-AC_CustomControl.md) | template |
| SVCP tests | `test/libraries/VRP_AC_CustomControl/` | planned |
