# Certification pack — VRP_TECS

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_TECS` |
| VR-Pilot module | `VRP_TECS` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_TECS/`)
...
Codice sorgente: `src/libraries/VRP_TECS/`
