# Certification pack — VRP_Soaring

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_Soaring` |
| VR-Pilot module | `VRP_Soaring` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_Soaring/`)
...
Codice sorgente: `src/libraries/VRP_Soaring/`
