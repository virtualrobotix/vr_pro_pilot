# Certification pack — VRP_AR_Motors

| Field | Value |
|---|---|
| ArduPilot equivalent | `AR_Motors` |
| VR-Pilot module | `VRP_AR_Motors` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_AR_Motors/`)
...
Codice sorgente: `src/libraries/VRP_AR_Motors/`
