# Certification pack — VRP_RC_Channel

| Field | Value |
|---|---|
| ArduPilot equivalent | `RC_Channel` |
| VR-Pilot module | `VRP_RC_Channel` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_RC_Channel/`)
...
Codice sorgente: `src/libraries/VRP_RC_Channel/`
