# Certification pack — VRP_BattMonitor

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_BattMonitor` |
| VR-Pilot module | `VRP_BattMonitor` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_BattMonitor/`)
...
Codice sorgente: `src/libraries/VRP_BattMonitor/`
