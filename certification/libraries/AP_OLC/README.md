# Certification pack — VRP_OLC

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_OLC` |
| VR-Pilot module | `VRP_OLC` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_OLC/`)
...
Codice sorgente: `src/libraries/VRP_OLC/`
