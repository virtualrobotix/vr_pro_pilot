# Certification pack — VRP_GSOF

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_GSOF` |
| VR-Pilot module | `VRP_GSOF` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_GSOF/`)
...
Codice sorgente: `src/libraries/VRP_GSOF/`
