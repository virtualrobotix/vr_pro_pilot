# Certification pack — VRP_RobotisServo

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_RobotisServo` |
| VR-Pilot module | `VRP_RobotisServo` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_RobotisServo/`)
...
Codice sorgente: `src/libraries/VRP_RobotisServo/`
