# Certification pack — VRP_Scheduler

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_Scheduler` |
| VR-Pilot module | `VRP_Scheduler` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_Scheduler/`)
...
Codice sorgente: `src/libraries/VRP_Scheduler/`
