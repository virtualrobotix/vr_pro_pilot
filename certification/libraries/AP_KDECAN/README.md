# Certification pack — VRP_KDECAN

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_KDECAN` |
| VR-Pilot module | `VRP_KDECAN` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_KDECAN/`)
...
Codice sorgente: `src/libraries/VRP_KDECAN/`
