# Certification pack — VRP_AIS

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_AIS` |
| VR-Pilot module | `VRP_AIS` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_AIS/`)
...
Codice sorgente: `src/libraries/VRP_AIS/`
