# Certification pack — VRP_CSVReader

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_CSVReader` |
| VR-Pilot module | `VRP_CSVReader` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_CSVReader/`)
...
Codice sorgente: `src/libraries/VRP_CSVReader/`
