# Certification pack — VRP_Terrain

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_Terrain` |
| VR-Pilot module | `VRP_Terrain` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_Terrain/`)
...
Codice sorgente: `src/libraries/VRP_Terrain/`
