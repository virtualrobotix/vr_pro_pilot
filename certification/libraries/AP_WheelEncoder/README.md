...
| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_WheelEncoder` |
...
| SDD | [`VRP-SDD-AP_WheelEncoder.md`](VRP-SDD-AP_WheelEncoder.md) | template |
| SVCP tests | `test/libraries/VRP_WheelEncoder/` | planned |
