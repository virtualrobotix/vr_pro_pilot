# Certification pack — VRP_Declination

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_Declination` |
| VR-Pilot module | `VRP_Declination` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_Declination/`)
...
Codice sorgente: `src/libraries/VRP_Declination/`
