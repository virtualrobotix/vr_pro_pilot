# Certification pack — VRP_FETtecOneWire

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_FETtecOneWire` |
| VR-Pilot module | `VRP_FETtecOneWire` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_FETtecOneWire/`)
...
Codice sorgente: `src/libraries/VRP_FETtecOneWire/`
