# Certification pack — VRP_GyroFFT

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_GyroFFT` |
| VR-Pilot module | `VRP_GyroFFT` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_GyroFFT/`)
...
Codice sorgente: `src/libraries/VRP_GyroFFT/`
