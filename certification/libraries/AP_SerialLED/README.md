# Certification pack — VRP_SerialLED

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_SerialLED` |
| VR-Pilot module | `VRP_SerialLED` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_SerialLED/`)
...
Codice sorgente: `src/libraries/VRP_SerialLED/`
