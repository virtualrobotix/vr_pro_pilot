# Certification pack — VRP_Gripper

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_Gripper` |
| VR-Pilot module | `VRP_Gripper` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_Gripper/`)
...
Codice sorgente: `src/libraries/VRP_Gripper/`
