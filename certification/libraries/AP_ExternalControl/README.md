...
| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_ExternalControl` |
...
| SDD | [`VRP-SDD-AP_ExternalControl.md`](VRP-SDD-AP_ExternalControl.md) | template |
| SVCP tests | `test/libraries/VRP_ExternalControl/` | planned |
