...
| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_SerialManager` |
...
| SDD | [`VRP-SDD-AP_SerialManager.md`](VRP-SDD-AP_SerialManager.md) | template |
| SVCP tests | `test/libraries/VRP_SerialManager/` | planned |
