# Certification pack — VRP_Winch

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_Winch` |
| VR-Pilot module | `VRP_Winch` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_Winch/`)
...
Codice sorgente: `src/libraries/VRP_Winch/`
