# Certification pack — VRP_Proximity

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_Proximity` |
| VR-Pilot module | `VRP_Proximity` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_Proximity/`)
...
Codice sorgente: `src/libraries/VRP_Proximity/`
