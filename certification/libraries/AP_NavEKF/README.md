# Certification pack — VRP_NavEKF

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_NavEKF` |
| VR-Pilot module | `VRP_NavEKF` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_NavEKF/`)
...
Codice sorgente: `src/libraries/VRP_NavEKF/`
