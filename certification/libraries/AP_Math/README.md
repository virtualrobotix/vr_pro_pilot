# Certification pack — VRP_Math

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_Math` |
| VR-Pilot module | `VRP_Math` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_Math/`)
...
Codice sorgente: `src/libraries/VRP_Math/`
