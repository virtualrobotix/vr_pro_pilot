# Certification pack — VRP_ROMFS

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_ROMFS` |
| VR-Pilot module | `VRP_ROMFS` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_ROMFS/`)
...
Codice sorgente: `src/libraries/VRP_ROMFS/`
