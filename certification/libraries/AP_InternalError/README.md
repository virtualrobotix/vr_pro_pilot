# Certification pack — VRP_InternalError

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_InternalError` |
| VR-Pilot module | `VRP_InternalError` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_InternalError/`)
...
Codice sorgente: `src/libraries/VRP_InternalError/`
