# Certification pack — VRP_BLHeli

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_BLHeli` |
| VR-Pilot module | `VRP_BLHeli` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_BLHeli/`)
...
Codice sorgente: `src/libraries/VRP_BLHeli/`
