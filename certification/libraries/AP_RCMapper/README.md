# Certification pack — VRP_RCMapper

| Field | Value |
|---|---|
| ArduPilot equivalent | `AP_RCMapper` |
| VR-Pilot module | `VRP_RCMapper` |
...
- [ ] Unit test interfaccia pubblica (`test/libraries/VRP_RCMapper/`)
...
Codice sorgente: `src/libraries/VRP_RCMapper/`
